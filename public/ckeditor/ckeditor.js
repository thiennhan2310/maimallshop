...
(function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype,
            {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (g)for (var s = 0; s < g.length; s++)b.push([a, c[d], g[s]].join("-")); else b.push([a, c[d]].join("-"));
                    for (a =
    ...
    (function () {
        function a(a, b) {
            ...
            if (this.current)g = this.current[q](false, l, h); else {
                if (a)g.type ==
    ...
    (function () {
        ...
        function d(a, b, c, d, o) {
            ...
            if (l && k.type == CKEDITOR.NODE_TEXT && q.equals(k)) {
                ...
                if (k.type == CKEDITOR.NODE_TEXT)l ? r = true : k = k.split(F); else if (k.getChildCount() > 0)if (F >= k.getChildCount()) {
                    k = k.getChild(F - 1);
                    H = true
                } else k = k.getChild(F); else K = H = true;
                if (q.type == CKEDITOR.NODE_TEXT)l ? E = true : q.split(m); else if (q.getChildCount() > 0)if (m === 0) {
                    q = q.getChild(m);
                    w = true
                } else q = q.getChild(m - 1); else A = w = true;
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                            ...
                            for (; l;) {
                                ...
                                if (l.type == CKEDITOR.NODE_COMMENT)l = l.getPrevious(); else {
                                    if (l.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        F = l.getText();
                                        if (d.test(F))l = null; else for (var w = l.$.getElementsByTagName("*"), H = 0, A; A = w[H++];)if (!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]) {
                                            l =
                                                null;
                                            break
                                        }
                        ...
                        if (m.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(m.substring(w)).length)k = true; else {
                            k = !m.getLength();
                            if (w == m.getLength()) {
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                for (this._.nextNode = null; t;) {
                    ...
                    (C = 0); else {
                        ...
                        if (CKEDITOR.dtd.$block[q] && t.getAttribute("contenteditable") == "false") {
                            ...
                            if (q == "br")C = 1; else if (!h && !t.getChildCount() && q != "hr") {
                                d = t;
                                s = t.equals(p);
                                break
                            }
                ...
                if (!d) {
                    ...
                    x = {div: 1, th: 1, td: 1};
                    d = d.block;
                    if (!d && t && !this.enforceRealBlocks && x[t.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !t.equals(h.root))d = t; else if (!d || this.enforceRealBlocks && d.is(j)) {
    ...
    (function () {
        function a(a, b, c, d, k) {
            ...
            for (var b = k.elements, k = k.generic, L, c = 0, d = a.length; c < d; ++c) {
                ...
                if (e.elements === true || e.elements === null)k[m ? "unshift" : "push"](e); else {
                    f = e.elements;
                    delete e.elements;
                    for (L in f)if (b[L])b[L][m ? "unshift" : "push"](e); else b[L] = [e]
                }
            }
        }
        ...
        function l(a, b, c) {
            var d = a.name;
            if (H.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(u()); else {
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))) {
                            f = z(k,
                                a, e, v);
                            if (f & A)g = true; else if (f & 2)return false
                        }
        ...
        function g(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var h in c) {
                    ...
                    if (A && !a.lang[h]) {
                        A.split && (A = A.split(","));
                        if (CKEDITOR.tools.indexOf(A, a.langCode) >= 0)j = a.langCode; else {
                            j = a.langCode.replace(/-.*/, "");
                            j = j != a.langCode && CKEDITOR.tools.indexOf(A, j) >= 0 ? j : CKEDITOR.tools.indexOf(A, "en") >= 0 ? "en" : A[0]
                        }
                        if (!i.langEntries || !i.langEntries[j])f.push(CKEDITOR.getUrl(i.path + "lang/" + j + ".js")); else {
            ...
            function (f, h, i) {
                ...
                o.onTagOpen = function (e, k, f, g) {
                    ...
                    if (a(k))t.push(k); else {
                        ...
                        if (e == "br")x.push(k); else {
                            for (; ;) {
                                g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                                if (!k.isUnknown && !u.isUnknown && !g[e])if (u.isOptionalClose)o.onTagClose(f); else if (e in b && f in b) {
                                    f = u.children;
                                    (f = f[f.length - 1]) && f.name == "li" || B(f = new CKEDITOR.htmlParser.element("li"), u);
                                    !k.returnPoint && (k.returnPoint = u);
                                    u = f
                                } else if (e in CKEDITOR.dtd.$listItem && !z(e, f))o.onTagOpen(e == "li" ? "ul" : "dl", {}, 0, 1); else if (f in d && !z(e, f)) {
                                    !k.returnPoint && (k.returnPoint = u);
                                    u = u.parent
                                } else {
                                    f in CKEDITOR.dtd.$inline && t.unshift(u);
                                    if (u.parent)B(u, u.parent, 1); else {
                                        k.isOrphan = 1;
                                        break
                                    }
                                } else break
                ...
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (v)for (m(v, 1) && g.push(v); v;) {
                            if (f(v) && (r = c(v)) && m(r))if ((h = c(r)) && !f(h))g.push(r); else {
                                k(w).insertAfter(r);
                                r.remove()
                            }
                            v = v.previous
                        ...
                        if (g = !a || (typeof d == "function" ? d(e) : d) !== false)if (!w && !CKEDITOR.env.needsBrFiller &&
                            e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)g = false; else if (!w && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))g = false; else {
                            g = b(e);
                ...
                if (!q.checkReadOnly()) {
                    ...
                    if (s) {
                        ...
                        for (f(y, t); q < y.length; q++) {
                            ...
                            if (G = E.isLineBreak) {
                                ...
                                if (E.hasBlockSibling)G = 1; else {
                                    Q = G.startContainer.getAscendant(h.$block, 1);
                                    if (!Q || !Q.is({div: 1, p: 1}))G = 0; else {
                                        S = Q.getPosition(N);
                                        if (S == CKEDITOR.POSITION_IDENTICAL || S == CKEDITOR.POSITION_CONTAINS)G = 0; else {
                                            N = G.splitElement(Q);
                    ...
                    if (!l.dontMoveCaret) {
                        for (x = a(I.startContainer) &&
                            ...
                            if (x.isBlockBoundary())I.moveToPosition(x, CKEDITOR.POSITION_BEFORE_END); else {
            ...
            var a = x ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, g, f, h = b.duplicate(), r = 0, l = e.length - 1, k = -1, i, j; r <= l;) {
                        ...
                        if (i > 0)l = k - 1; else if (i < 0)r = k + 1; else return {container: d, offset: a(g)}
                    }
    ...
    (function () {
            ...
            function c(a) {
                return {
                    type: a, canUndo: "cut" == a, startDisabled: !0, exec: function () {
                        ...
                        var a;
                        var d = this.type;
                        if (CKEDITOR.env.ie)a = g(d); else try {
            ...
            requires: "dialog", init: function (b) {
                ...
                b.on("paste", function (a) {
                    ...
                    if (!a.data.dataValue) {
                        ...
                        if (f)a.data.dataValue = f, a.data.type = "html"; else if (f = c.getData("text/plain"))a.data.dataValue = b.editable().transformPlainTextToHtml(f),
                            a.data.type = "text"
                    }
                }, null, null, 1);
                b.on("paste", function (a) {
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            getRangeAtDropPosition: function (b, a) {
                ...
                if (document.caretRangeFromPoint)c = a.document.$.caretRangeFromPoint(d, e), g.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), g.collapse(!0); else if (c.rangeParent)g.setStart(CKEDITOR.dom.node(c.rangeParent),
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                if (!o.equals(a.editable()) && "html" != o.getName())p = o.getClientRect(), d < p.left ? g.setStartAt(o, CKEDITOR.POSITION_AFTER_START) : g.setStartAt(o, CKEDITOR.POSITION_BEFORE_END), g.collapse(!0); else return f && f.startContainer && !f.startContainer.equals(a.editable()) ? f : null
                            }
                        } catch (r) {
                            return null
                        }
